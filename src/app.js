...
// ── Technician email notification (Task [5], extracted in Task [8a]) ───────
// buildTechnicianEmail() and sendSummaryEmail() now live in src/email.js.
// They are imported at the top of this file via require("./email") and the
// existing call sites and module.exports.buildTechnicianEmail re-export are
// unchanged. Behavior is identical — this was a structural extraction only.
